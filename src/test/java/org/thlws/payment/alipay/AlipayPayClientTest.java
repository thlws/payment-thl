...
public class AlipayPayClientTest {
	...
	public void init() {
		...
		alipayCore = clientBuilder.setAlipayPublicKey(alipay_public_key_2).setAppId(appid_2)
				.setPrivateKey(private_key_2).setSignType(AlipayConstants.SIGN_TYPE_RSA2).build();
	}
