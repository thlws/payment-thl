...
public class ExtitemDetailInfo extends AlipayObject {
     ...
     * Sets extitem id.
     *
     * @param extitemId the extitem id
     */
     ...
     * Sets extitem name.
     *
     * @param extitemName the extitem name
     */
    ...
    /**
     * Gets goods component list.
     *
     * @return the goods component list
     */
    ...
    /**
     * Sets goods component list.
     *
     * @param goodsComponentList the goods component list
     */
