...
public class PosDeviceInfoVO extends AlipayObject {
	...
	private static final long serialVersionUID = 4168252245793392129L;
     ...
     *
     * @return the decive software name
     */
     ...
     *
     * @param deciveSoftwareName the decive software name
     */
     ...
     * Sets device app cnt.
     *
     * @param deviceAppCnt the device app cnt
     */
     ...
     *
     * @param deviceAppFlow the device app flow
     */
     ...
     *
     * @param deviceAppList the device app list
     */
     ...
     *
     * @return the device company name
     */
     ...
     *
     * @param deviceCompanyName the device company name
     */
     ...
     * Sets device flow.
     *
     * @param deviceFlow the device flow
     */
     ...
     *
     * @param deviceOsVersion the device os version
     */
     ...
     * Sets gmt activate.
     *
     * @param gmtActivate the gmt activate
     */
     ...
     * Sets gmt production.
     *
     * @param gmtProduction the gmt production
     */
     ...
     * Sets gmt unbundling.
     *
     * @param gmtUnbundling the gmt unbundling
     */
