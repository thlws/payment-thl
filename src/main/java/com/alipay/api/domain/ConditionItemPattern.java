...
public class ConditionItemPattern extends AlipayObject {
	...
	private static final long serialVersionUID = 5899945477267211178L;
     ...
     * Sets operator rule.
     *
     * @param operatorRule the operator rule
     */
