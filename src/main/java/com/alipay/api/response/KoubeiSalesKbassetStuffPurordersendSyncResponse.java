...
public class KoubeiSalesKbassetStuffPurordersendSyncResponse extends AlipayResponse {
    ...
    /**
     * Sets purchase order send results.
     *
     * @param purchaseOrderSendResults the purchase order send results
     */
    ...
    /**
     * Gets purchase order send results.
     *
     * @return the purchase order send results
     */
