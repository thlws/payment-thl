...
public class KoubeiCateringDishMaterialQueryResponse extends AlipayResponse {
    ...
    /**
     * Sets kb dish material info list.
     *
     * @param kbDishMaterialInfoList the kb dish material info list
     */
    ...
    /**
     * Gets kb dish material info list.
     *
     * @return the kb dish material info list
     */
